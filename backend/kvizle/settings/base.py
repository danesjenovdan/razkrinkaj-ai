"""
Django settings for kvizle project.
...
WSGI_APPLICATION = "kvizle.wsgi.application"
...
# Allowed file extensions for images in the image library. Added "svg" for vector images.
